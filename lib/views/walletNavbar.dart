...
class WalletNavbarScreen extends StatefulWidget {
  const WalletNavbarScreen({Key? key}) : super(key: key);

  @override
  State<WalletNavbarScreen> createState() => _WalletNavbarScreenState();
}

class _WalletNavbarScreenState extends State<WalletNavbarScreen> {
  late String phone;
  late String balance;
  bool isLoading = true;
